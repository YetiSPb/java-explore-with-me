...
public class RatingController {
    ...
    @GetMapping("/events")
    public List<EventShortRatingDto> searchEventsWithRating(@PositiveOrZero @RequestParam(defaultValue = "0") Integer from,
        ...
        SearchEventParams params = SearchEventParams.builder()
                ...
                .build();
        return ratingService.searchEventsWithRating(params, page);
    }
    ...
    public List<UserShortRatingDto> findMostPopularUsers(@PositiveOrZero @RequestParam(defaultValue = "0") Integer from,
        ...
        Pageable page = PageRequest.of(from / size, size);
        return ratingService.searchMostPopularUsers(page);
    }
}
