...
public class AdminEventController {
    ...
    public List<EventFullDto> searchEventsForAdmin(@PositiveOrZero @RequestParam(defaultValue = "0") Integer from,
        ...
        return eventService.searchEventsForAdmin(users, states, categories, rangeStart, rangeEnd, page);
    }
