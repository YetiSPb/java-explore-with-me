...
public class EventServiceImpl implements EventService {
    ...
    @Override
    public List<EventShortDto> searchAllEvents(Long userId, Integer from, Integer size) {
        checkUserId(userId);
    ...
    @Override
    public EventFullDto searchById(Long userId, Long eventId) {
        checkUserId(userId);
    ...
    @Override
    public List<ParticipationRequestDto> searchParticipationRequests(Long userId, Long eventId) {
        checkUserId(userId);
        checkEventId(eventId);
    ...
    @Override
    public List<EventFullDto> searchEventsForAdmin(List<Long> users, List<EventState> states, List<Integer> categories,
    ...
    @Override
    public EventFullDto searchByIdPublic(Long eventId, HttpServletRequest request) {
        Event event = checkEventId(eventId);
        if (!event.getState().equals(EventState.PUBLISHED)) {
