...
public class RatingServiceImpl implements RatingService {
    ...
    @Override
    public List<EventShortRatingDto> searchEventsWithRating(SearchEventParams params, Pageable page) {
    ...
    @Override
    public List<UserShortRatingDto> searchMostPopularUsers(Pageable page) {
